          ...
          <ul>
            ...
            <div id="remaining_01">
              ...
              <div id="second_menu_hidden">
                ...
                <p>Analog Seconds <input class="jscolor {onFineChange:'analog_seconds(this)'}" value="FF0000"></input> </p>
                <p>Center Dot <input class="jscolor {onFineChange:'center_circule(this)'}" value="fff"></input> </p>
              </div>
              <div id="remaining_02">
                <li class="elementos_menu_direito"  onclick="togglemenu3()">Line</li>
                <div id="third_menu_hidden">
                  <p>Circle Bar 1</p> <br> <input class="jscolor {onFineChange:'bar_color1(this)'}" name="b1_color" value="FF0000" ></input></br>
                  <p>Circle Bar 2</p> <br> <input class="jscolor {onFineChange:'bar_color2(this)'}" name="b2_color" value="00acc1" ></input></br>
                  <p>Circle Bar 1 Size </p><br> <input id="bar_size1"  value="100" max="89" onchange="bar_thickness_1()" type="range" name="b_size" ></input></br>
                  <p>Circle Bar 2 Size </p> <br> <input id="bar_size2" value="100" max="89" onchange="bar_thickness_2()" type="range" name="b_size" ></input></br>
                  <p>Circle Bar Radius </p> <br> <input id="bar_radius" min="59" onchange="bars_radius()" type="range" name="b_radius" value="100"></input></br>
                  <p>Circle Bar Start </p><br> </br>
